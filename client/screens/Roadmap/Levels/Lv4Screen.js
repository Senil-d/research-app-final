...
const Lv4Screen = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.subtitle}>Complete the tasks for Level 4</Text>
      ...
      {completed && (
        <TouchableOpacity style={styles.nextButton} onPress={handleCompleteLevel}>
          <Text style={styles.nextButtonText}>Complete Level 4</Text>
        </TouchableOpacity>
      )}
    </View>
  )
